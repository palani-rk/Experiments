        ...
        children: [
          Row(
            ...
            children: [
              Text(
                currentSection,
                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.teal[800]),
              ),
              Text(
        ...
        children: [
          if (isBot) ...[
            CircleAvatar(
              radius: 16,
              backgroundColor: Colors.teal[100],
              child: Icon(Icons.smart_toy, size: 16, color: Colors.teal[600]),
            ),
            SizedBox(width: 8),
          ],
          Flexible(
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.person_outline, color: Colors.teal[700], size: 20),
                SizedBox(width: 8),
                Text(
                  'PERSONAL INFO',
                  style: TextStyle(
          ...
          Row(
            children: [
              CircleAvatar(
                radius: 8,
                backgroundColor: Colors.teal[100],
                child: Icon(Icons.smart_toy, size: 10, color: Colors.teal[600]),
              ),
              SizedBox(width: 8),
              Expanded(
                child: Text(
