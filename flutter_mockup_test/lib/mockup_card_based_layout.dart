      ...
      title: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.local_hospital, color: Theme.of(context).colorScheme.onPrimary, size: 24),
          ),
          SizedBox(width: 12),
          Column(
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Card(
          ...
          color: message.isBot ? Theme.of(context).colorScheme.surface : Theme.of(context).colorScheme.primaryContainer,
                ...
                Row(
                  children: [
                    ...
                    if (message.isEditable) ...[
                      SizedBox(width: 8),
                      IconButton(
                        icon: Icon(Icons.edit, size: 20, color: Theme.of(context).colorScheme.onSurfaceVariant),
                        onPressed: () {
                          // Handle edit action
                        },
