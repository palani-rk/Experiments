...
/// Design system constants for consistent spacing, sizes, and styling
class AppSizes {
  // Spacing Scale
  ...
  // Avatar Sizes
  static const double avatarXs = 8.0;
  static const double avatarS = 16.0;
  static const double avatarM = 20.0;

  // Chat specific sizes
  static const double chatBubbleMaxWidthRatio = 0.75;
...
/// Text styles extending the Material Design text theme
class AppTextStyles {
  ...
  static const TextStyle currentQuestionText = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w500,
  );
...
class AppShadows {
  ...
  static List<BoxShadow> chatBubble(BuildContext context) => [
    BoxShadow(
      color: Theme.of(context).colorScheme.outline.withOpacity(0.1),
      spreadRadius: 1,
      blurRadius: 3,
